...
def initialise_rotor_position(rotor, position):
    ...
    list_beginning = rotor["rotor"][position-1:len(rotor["rotor"])]
    list_end = rotor["rotor"][0:position-1]
...
def rotate_rotors():
    """Rotate the rotors (change order of letters in list) after each keypress"""
...
def encrypt(starting_position):
    ...
    rotor_3_letter = rotor_3["rotor"][int(starting_position)-1]
...
def main():
    ...
    # TODO: DIFFERENT ENCRYPTION RESULT FOR DIFFERENT STARTER POSITIONS
